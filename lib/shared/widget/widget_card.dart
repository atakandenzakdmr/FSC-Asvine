...
class WidgetCard extends StatelessWidget implements PreferredSizeWidget {
                ...
                child: Column(
                  children: [
                    Expanded(
                      flex: 5,
                      child: ListTile(
                        title: Text("Les Benjamins x MANGO", style: AsvineTxtStyle.newsTitleStyle),
                        subtitle: Text(homeNewsSubTitle1, style: AsvineTxtStyle.newsSubtitleStyle),
                      ),
                    ),
                    Expanded(
                      flex: 5,
