...
class WidgetCard2 extends StatelessWidget implements PreferredSizeWidget {
                ...
                child: Column(
                  children: [
                    Expanded(
                      flex: 5,
                      child: ListTile(
                        title: Text("Sonbahar Koleksiyonu", style: AsvineTxtStyle.newsTitleStyle),
                        subtitle: Text(homeNewsSubTitle2, style: AsvineTxtStyle.newsSubtitleStyle),
                      ),
                    ),
                    Expanded(
                      flex: 5,
